...
def 안톤무기바지벨트목걸이반지10():
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급안톤_검은화산10_2', threshold=0.8))
...
def 안톤무기바지벨트목걸이반지30():
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급안톤_검은화산30_2', threshold=0.8))
...
def 안톤상의어깨신발팔찌보장10():
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급던전_검은연기10_2', threshold=0.8))
...
def 안톤상의어깨신발팔찌보장30():
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급던전_검은연기30_2', threshold=0.8))
...
map = {
    ...
    "윈드꾸꾸": Unit("윈드꾸꾸", s='안톤상의어깨신발팔찌보장'),
    "보리닉": Unit("보리닉", s='안톤상의어깨신발팔찌보장'),
    "보리뱅": Unit("보리뱅", s='안톤상의어깨신발팔찌보장'),
}
...
for key in map:
    ...
    # time.sleep(2)
    if (do(Founder('상급던전_입장', threshold=0.84), onlyOneTime=True) or do(Founder('금고아이템사용'), onlyOneTime=True)):
        print('재료소진')
        do(Clicker('x'), onlyOneTime=True)
        do(Clicker('뒤로가기'))
        do(Clicker('뒤로가기'))
        do(Clicker('뒤로가기'))
        continue
