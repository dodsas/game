...
def 안톤무기바지벨트목걸이반지10():
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급안톤_검은화산10_2', threshold=0.80))
def 안톤무기바지벨트목걸이반지30():
    do(Clicker('상던안톤', threshold=0.72))
    # do(Clicker('상급던전_다음표시'))
    # do(Clicker('상급안톤_검은화산30'))
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급안톤_검은화산30_2', threshold=0.78))
def 안톤상의어깨신발팔찌보장10():
    do(Clicker('상던안톤', threshold=0.72))
    # do(Clicker('상급던전_다음표시'))
    # do(Clicker('상급던전_다음표시'))
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급던전_검은연기10_2', threshold=0.80))
def 안톤상의어깨신발팔찌보장30():
    do(Clicker('상던안톤', threshold=0.72))
    # do(Clicker('상급던전_다음표시'))
    # do(Clicker('상급던전_다음표시'))
    ...
    do(Clicker('상급던전_네비게이션'))
    do(Clicker('상급던전_검은연기30_2', threshold=0.80))
