...
def 무기목걸이어깨신발210():
    do(Clicker('파워스테이션', threshold=0.85))
    do(Clicker('상급던전_다음표시'))
    do(Clicker('파워스테이션_그란디네10'))

def 무기목걸이어깨신발230():
    do(Clicker('파워스테이션', threshold=0.85))
    do(Clicker('상급던전_다음표시'))
    do(Clicker('파워스테이션_그란디네30'))
...
def 안톤무기바지벨트목걸이반지10():
    do(Clicker('상던안톤', threshold=0.73))
    do(Clicker('상급던전_다음표시'))
...
map = {
 ...
 "보리세이더": Unit("보리세이더", s='안톤무기바지벨트목걸이반지'),
  ...
  "소울뚜": Unit("소울뚜", s='반지상의하의보장팔찌벨트2'),
   "런처꾸꾸": Unit("런처꾸꾸", s='반지상의하의보장팔찌벨트2'),
    "보리술사": Unit("보리술사", s='반지상의하의보장팔찌벨트2'),
   "보리커": Unit("보리커", s='반지상의하의보장팔찌벨트2'),
   ...
   "건꾸꾸": Unit("건꾸꾸", s='무기목걸이어깨신발2'),
    ...
    "보리뚜비": Unit("보리뚜비", s='무기목걸이어깨신발2'),
    "웨펀꾸꾸": Unit("웨펀꾸꾸", s='무기목걸이어깨신발2'),
    "보리메이지": Unit("보리메이지", s='무기목걸이어깨신발2'),
