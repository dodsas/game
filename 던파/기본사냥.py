...
# map of Unit objects
map = {
    # "보리성": Unit("보리성", 4, 'w', 신비전체구매=True, 산등노가다=False, 길드기부=True),
    ...
    "런처꾸꾸": Unit("런처꾸꾸", 6, 'w', 신비전체구매=True),
    ...
    "베인뚜": Unit("베인뚜", 6, 'w', 신비전체구매=True, 길드기부=True),
    "보리핏": Unit("보리핏", 3, 'w', 신비전체구매=True, 길드기부=True),
    "보리파": Unit("보리파", 3, 'w', 신비전체구매=True, 길드기부=True),
    "무녀뚜": Unit("무녀뚜", 3, 'w', 신비전체구매=True, 길드기부=True),
}
